...
public class bodyController : MonoBehaviour
{
    ...
    public float waitTimeBetweenEveryStep = 0;
    ...
    IEnumerator step(int index, Vector3 moveTo, bool isOpposite)
    {
        ...
        {
            legTargets[index].transform.position = Vector3.Lerp(startPos, moveTo + new Vector3(0, Mathf.Sin(i / (float)(LegSmoothness) * Mathf.PI) * stepHeight, 0), (i / LegSmoothness));
